...
const MapContainer = ({ currentLocation, updateLocation, distanceToTarget, gameStarted }) => {
        ...
        <div className="map">
            <div className="map-container">
                ...
                >
                    ...
                    <LocationMarker position={position} distanceToTarget={distanceToTarget} gameStarted={gameStarted}  />{" "}
